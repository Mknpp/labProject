...
public class ValidadorEtapa4 {
    ...
    public static void main(String[] args){
        ...
        System.out.println(total == 2 ? "[OK] Método Shopping.quantidadeLojasPorTipo() - localizou duas lojas" : (total + "[NOK] Método Shopping.quantidadeLojasPorTipo() - não conseguiu localizar as lojas"));
